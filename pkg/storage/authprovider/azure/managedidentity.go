...
var _ common.StorageAuthProvider = (*ManagedIdentityAuthProvider)(nil)

// NewMySQL implements authprovider.StorageAuthProvider.
func (p *ManagedIdentityAuthProvider) NewMySQL(uri string, cfg *sqlcommon.Config) (*sql.DB, error) {
...
func (p *ManagedIdentityAuthProvider) NewPosgreSQL(uri string, cfg *sqlcommon.Config) (*sql.DB, error) {
	if cfg.Username != "" || cfg.Password != "" {
